<?php
class EYE_FooterBottomWidget extends WP_Widget {
    /** constructor */
    function EYE_FooterBottomWidget() {
        parent::WP_Widget(false, $name = 'Footer - Bottom Areas');	
    }
...
<table cellpadding="5" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            ...
            src="<?php if(!empty($instance['image_uri'])){echo $instance['image_uri'];} else { echo bloginfo('template_url').'/widgets/no-image.gif';} ?>" />
        </td>
        <td>
...
<table cellpadding="5" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            ...
            src="<?php if(!empty($instance['image_uri2'])){echo $instance['image_uri2'];} else { echo bloginfo('template_url').'/widgets/no-image.gif';} ?>" />
        </td>
        <td>
...
<table cellpadding="5" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            ...
            src="<?php if(!empty($instance['image_uri3'])){echo $instance['image_uri3'];} else { echo bloginfo('template_url').'/widgets/no-image.gif';} ?>" />
        </td>
        <td>
...
<table cellpadding="5" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            ...
            src="<?php if(!empty($instance['image_uri4'])){echo $instance['image_uri4'];} else { echo bloginfo('template_url').'/widgets/no-image.gif';} ?>" />
        </td>
        <td>
